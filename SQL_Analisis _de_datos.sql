			 ...
			 ## Análisis de datos de la Energia Global Sostenible entre el 2000 y 2019
...
## 2. ¿Qué pais ha participado en el registro de datos de energía sostenible durante todo el periodo 2000-2019?:
...
## 5. Electricidad generada por los tres tipos de energía por pais:
...
## 6. Top15 paises con mayor porcentaje de población con acceso a la electricidad:
...
## 7. Pais de menor y mayor capacidad instalada de energía renovable per_capita durante el 2015-2019:
...
## 11. Cuántos paises participaron durante el periodo 2000-2019 en el registro de datos de energía sostenible?:
...
## 13. ¿Cuántas veces ha participado cada nación en el registro de indicadodres de energía sostenible durante el periodo 2000-2019?:
...
## 16. ¿Cuántos paises participaron para cada año?
...
## 18. Top15 paises con mayor porcentaje de electricidad procedente de fuentes bajas en carbono durante el periodo 2015-2019:
...
## 20. Mayor emisión de dióxido de carbono (CO2) per capita de paises que participaron durante todo el periodo:
...
## 22. Top15 paises de mayor crecimiento anual del PIB en el 2019:
...
## 23. Top10 de paises con mejor PIB durante el periodo 2010-2019:

SELECT  Pais, AVG(PIB_percapita) AS PIB_percapita
FROM global_energy
WHERE Año >= 2010
GROUP BY Pais
ORDER BY AVG(PIB_percapita) DESC
LIMIT 10;


## 24. Mayor y menor densidad de población (km2) de paises que participaron durante los últimos 5 años:
...
## 25. Cinco Paises con mayor área de terreno (km2) que participaron en la base de datos de energía sostenible en los últimos tres años:

SELECT Pais,  AVG(area_terreno_Km2) AS Area_Terreno
FROM global_energy
WHERE Año >= 2017 
GROUP BY Pais
ORDER BY AVG(area_terreno_Km2) DESC
LIMIT 5;
